...
KOSMOS2 の PRA32-U2M(Lite) 対応における根幹思想は次の一点です。
...
*   音源（PRA32-U2M(Lite)）は **同一パート内で4音を同時発音**
*   結果として **最大4音ポリフォニック**
...
以下は **KOSMOS2 → PRA32-U2M(Lite)** の関係を示した概念図です。
```mermaid
flowchart LR
